...
public class C05_ObjectVariables {
    public static void main(String[] args) {
        ...
        C03_ObjectVariables pers1=new C03_ObjectVariables(); // bi nevi Scanner olarak dusun bunu
        ...
        C03_ObjectVariables pers2= new C03_ObjectVariables(); // bi object daha olusturduk
        ...
        C03_ObjectVariables pers3= new C03_ObjectVariables(); // bi object daha
